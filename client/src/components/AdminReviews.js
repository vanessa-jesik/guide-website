          ...
          {reviews ? (
            reviews.map(review => (
              ...
              >
                ...
                <br />
                <p className="whitespace-nowrap ml-auto">
                  {review.client.full_name}
                </p>
                <button
                  type="button"
                  data-hs-overlay={`#delete-review-modal-${review.id}`}
                  className="ml-auto bg-lapis text-parchment px-4 py-2 border-solid border-2 border-lapis-dark rounded-md hover:bg-hunter"
                >
                  Delete
                  <br />
                  Review
                ...
                <div
                  id={`delete-review-modal-${review.id}`}
