  ...
  return clientTrips ? (
    <div className="m-10">
      <div className="flex text-center bg-gray-100">
        <div className="flex-1 font-bold border border-gray-300 p-2">ID</div>
        <div className="flex-1 font-bold border border-gray-300 p-2">Date</div>
        <div className="flex-1 font-bold border border-gray-300 p-2">Trip</div>
        ...
        <div className="flex-1 font-bold border border-gray-300 p-2">Paid</div>
        <div className="flex-1 font-bold border border-gray-300 p-2">Notes</div>
      </div>
